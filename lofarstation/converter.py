...
def create_parser():
    ...
    parser.add_argument("-p", "--npol", type=int, default=2)
...
def main():
    ...
    if args.acc:
        ...
        station_data = AARTFAACData (args.indata, args.rcumode, args.subband,args.nchan, args.npol, args.antfield, args.starttime, args.direction, args.stationname)
    else:
